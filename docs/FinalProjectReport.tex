...
\usepackage{listings}
%Settings taken and modified from: https://en.wikibooks.org/wiki/LaTeX/Source_Code_Listings
\lstset{ %
...
% Add an abstract.
\abstract{This research focuses on utilizing distributed testing
    to make the execution of large test suites more efficient. The key
    trade-offs for taking a distributed approach to testing are identified
...
\lstinputlisting[language=Java]{../code/src/delegator/Delegator.java}

\newpage
\subsubsection{\texttt{CustomServer}}
\lstinputlisting[language=Java]{../code/src/server/CustomServer.java}

\newpage
\subsubsection{\texttt{CustomClassLoader}}
\lstinputlisting[language=Java]{../code/src/server/CustomClassLoader.java}

\newpage
\subsubsection{\texttt{TestAgent}}
\lstinputlisting[language=Java]{../code/src/delegator/TestAgent.java}
